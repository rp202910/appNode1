...
public class ExactExpenseServcieImpl implements ExpenseService {

    private DatabaseStrategy db;

    public ExactExpenseServcieImpl(DatabaseStrategy db) {
        this.db = db;
    }
    ...
    public Expense addExpense(String name, double amount, Integer paidUser, List<Integer> userIds, List<Double> userAmount) {
        ...
        for (Integer payeeId : userIds) {
            ...
            Split split = new Split(paidUser, payeeId, userAmount.get(userNo));
